...
public class WebClient {
	 ...
	 */
	public void sendHttpRequest(String host) throws UnknownHostException, IOException {
		System.out.println("Connecting to server...");
		socket = new Socket(InetAddress.getByName(host), 9001);
		
		// create and send HTTP request
		System.out.println("Sending file request...");
		String httpRequest = "GET " + "sample.html" + " HTTP/1.0\r\n"
							+ "Host: " + host + "\r\n"
							+ "\r\n";
